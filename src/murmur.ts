...
const x64Add = function (t: any, r: any) {
  ...
  x64Multiply = function (t: any, r: any) {
    ;(t = [t[0] >>> 16, 65535 & t[0], t[1] >>> 16, 65535 & t[1]]),
      (r = [r[0] >>> 16, 65535 & r[0], r[1] >>> 16, 65535 & r[1]])
    var e = [0, 0, 0, 0]
    return (
  ...
  x64Rotl = function (t: any, r: any) {
    return 32 === (r %= 64)
      ? [t[1], t[0]]
      : r < 32
        ? [(t[0] << r) | (t[1] >>> (32 - r)), (t[1] << r) | (t[0] >>> (32 - r))]
        : ((r -= 32),
          [
            (t[1] << r) | (t[0] >>> (32 - r)),
            (t[0] << r) | (t[1] >>> (32 - r)),
  ...
  x64LeftShift = function (t: any, r: any) {
    return 0 === (r %= 64)
      ? t
      : r < 32
  ...
  x64hash128 = function (t: any, r: any) {
    r = r || 0
    for (
      var e = (t = t || '').length % 16,
        o = t.length - e,
