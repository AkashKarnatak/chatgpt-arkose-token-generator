...
function getFingerprint() {
    ...
    fingerprint['CFP'] =
        'canvas winding:yes~canvas fp:data:image/png;base64,' +
            (0, crypto_1.randomBytes)(128).toString('base64');
...
function getEnhancedFingerprint(fp, ua, opts) {
    ...
    fingerprint.webgl_hash_webgl = (0, murmur_1.default)(Object.entries(fingerprint)
    ...
    fingerprint.audio_fingerprint = (124.04347527516074 +
        Math.random() * 0.001 -
        0.0005).toString();
